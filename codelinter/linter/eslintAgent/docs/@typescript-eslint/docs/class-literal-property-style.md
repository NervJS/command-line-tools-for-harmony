...
> See [***documentation***](https://developer.huawei.com/consumer/{{region}}/doc/harmonyos-guides-{{apiVersion}}/ide_class-literal-property-style-{{apiVersion}}) for more details.
