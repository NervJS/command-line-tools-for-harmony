...
>See [***documentation***](https://developer.huawei.com/consumer/{{region}}/doc/harmonyos-guides-{{apiVersion}}/ide-lottie-animation-destroy-check-{{apiVersion}}) for more details.
