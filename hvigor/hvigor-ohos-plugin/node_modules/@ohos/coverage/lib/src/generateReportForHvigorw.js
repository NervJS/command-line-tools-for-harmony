...
async function generateReportForHvigorw(projectPath, reportPath, coveragePath) {
    ...
    let initCoverageData = (0, report_1.getInitCoverageData)(coveragePaths);
    let jsCoverageData = (0, report_1.getjsCoverageData)(coveragePaths);
    ...
    (0, report_1.report)(reportPath, etsCoverageDataPath);
}
