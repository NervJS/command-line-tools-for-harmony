/*
  @license
	Rollup.js v3.19.1-htrunk1.AllScenario.devecostudio.r2
	Thu, 23 Jan 2025 08:19:28 GMT - commit 03ba541d2cce54931e224ab806ab937f1d60d681
...
var version$1 = "3.19.1-htrunk1.AllScenario.devecostudio.r2";
...
function simple(node, visitors, baseVisitor, state, override) {
  if (!baseVisitor) { baseVisitor = base$2
  ; }(function c(node, st, override) {
    var type = override || node.type, found = visitors[type];
    baseVisitor[type] && baseVisitor[type](node, st, c);
...
base$2.Program = base$2.BlockStatement = base$2.StaticBlock = function (node, st, c) {
...
base$2.Statement = skipThrough$1;
base$2.EmptyStatement = ignore$1;
base$2.ExpressionStatement = base$2.ParenthesizedExpression = base$2.ChainExpression =
  function (node, st, c) { return c(node.expression, st, "Expression"); };
base$2.IfStatement = function (node, st, c) {
  c(node.test, st, "Expression");
  c(node.consequent, st, "Statement");
  if (node.alternate) { c(node.alternate, st, "Statement"); }
};
base$2.LabeledStatement = function (node, st, c) { return c(node.body, st, "Statement"); };
base$2.BreakStatement = base$2.ContinueStatement = ignore$1;
base$2.WithStatement = function (node, st, c) {
  c(node.object, st, "Expression");
  c(node.body, st, "Statement");
};
base$2.SwitchStatement = function (node, st, c) {
...
base$2.SwitchCase = function (node, st, c) {
...
base$2.ReturnStatement = base$2.YieldExpression = base$2.AwaitExpression = function (node, st, c) {
  if (node.argument) { c(node.argument, st, "Expression"); }
};
base$2.ThrowStatement = base$2.SpreadElement =
  function (node, st, c) { return c(node.argument, st, "Expression"); };
base$2.TryStatement = function (node, st, c) {
  c(node.block, st, "Statement");
  if (node.handler) { c(node.handler, st); }
  if (node.finalizer) { c(node.finalizer, st, "Statement"); }
};
base$2.CatchClause = function (node, st, c) {
  if (node.param) { c(node.param, st, "Pattern"); }
  c(node.body, st, "Statement");
};
base$2.WhileStatement = base$2.DoWhileStatement = function (node, st, c) {
  c(node.test, st, "Expression");
  c(node.body, st, "Statement");
};
base$2.ForStatement = function (node, st, c) {
  if (node.init) { c(node.init, st, "ForInit"); }
  if (node.test) { c(node.test, st, "Expression"); }
  if (node.update) { c(node.update, st, "Expression"); }
  c(node.body, st, "Statement");
};
base$2.ForInStatement = base$2.ForOfStatement = function (node, st, c) {
  c(node.left, st, "ForInit");
  c(node.right, st, "Expression");
  c(node.body, st, "Statement");
};
base$2.ForInit = function (node, st, c) {
  if (node.type === "VariableDeclaration") { c(node, st); }
  else { c(node, st, "Expression"); }
};
base$2.DebuggerStatement = ignore$1;

base$2.FunctionDeclaration = function (node, st, c) { return c(node, st, "Function"); };
base$2.VariableDeclaration = function (node, st, c) {
...
base$2.VariableDeclarator = function (node, st, c) {
  c(node.id, st, "Pattern");
  if (node.init) { c(node.init, st, "Expression"); }
};

base$2.Function = function (node, st, c) {
...
base$2.Pattern = function (node, st, c) {
...
base$2.VariablePattern = ignore$1;
base$2.MemberPattern = skipThrough$1;
base$2.RestElement = function (node, st, c) { return c(node.argument, st, "Pattern"); };
base$2.ArrayPattern = function (node, st, c) {
...
base$2.ObjectPattern = function (node, st, c) {
...
base$2.Expression = skipThrough$1;
base$2.ThisExpression = base$2.Super = base$2.MetaProperty = ignore$1;
base$2.ArrayExpression = function (node, st, c) {
  for (var i = 0, list = node.elements; i < list.length; i += 1) {
    var elt = list[i];
...
base$2.ObjectExpression = function (node, st, c) {
  for (var i = 0, list = node.properties; i < list.length; i += 1)
    {
    var prop = list[i];
...
base$2.FunctionExpression = base$2.ArrowFunctionExpression = base$2.FunctionDeclaration;
base$2.SequenceExpression = function (node, st, c) {
...
base$2.TemplateLiteral = function (node, st, c) {
...
base$2.TemplateElement = ignore$1;
base$2.UnaryExpression = base$2.UpdateExpression = function (node, st, c) {
  c(node.argument, st, "Expression");
};
base$2.BinaryExpression = base$2.LogicalExpression = function (node, st, c) {
  c(node.left, st, "Expression");
  c(node.right, st, "Expression");
};
base$2.AssignmentExpression = base$2.AssignmentPattern = function (node, st, c) {
  c(node.left, st, "Pattern");
  c(node.right, st, "Expression");
};
base$2.ConditionalExpression = function (node, st, c) {
  c(node.test, st, "Expression");
  c(node.consequent, st, "Expression");
  c(node.alternate, st, "Expression");
};
base$2.NewExpression = base$2.CallExpression = function (node, st, c) {
...
base$2.MemberExpression = function (node, st, c) {
  c(node.object, st, "Expression");
  if (node.computed) { c(node.property, st, "Expression"); }
};
base$2.ExportNamedDeclaration = base$2.ExportDefaultDeclaration = function (node, st, c) {
  if (node.declaration)
    { c(node.declaration, st, node.type === "ExportNamedDeclaration" || node.declaration.id ? "Statement" : "Expression"); }
  if (node.source) { c(node.source, st, "Expression"); }
};
base$2.ExportAllDeclaration = function (node, st, c) {
  if (node.exported)
    { c(node.exported, st); }
  c(node.source, st, "Expression");
};
base$2.ImportDeclaration = function (node, st, c) {
...
base$2.ImportExpression = function (node, st, c) {
  c(node.source, st, "Expression");
};
base$2.ImportSpecifier = base$2.ImportDefaultSpecifier = base$2.ImportNamespaceSpecifier = base$2.Identifier = base$2.PrivateIdentifier = base$2.Literal = ignore$1;

base$2.TaggedTemplateExpression = function (node, st, c) {
  c(node.tag, st, "Expression");
  c(node.quasi, st, "Expression");
};
base$2.ClassDeclaration = base$2.ClassExpression = function (node, st, c) { return c(node, st, "Class"); };
base$2.Class = function (node, st, c) {
  if (node.id) { c(node.id, st, "Pattern"); }
  if (node.superClass) { c(node.superClass, st, "Expression"); }
  c(node.body, st);
};
base$2.ClassBody = function (node, st, c) {
  for (var i = 0, list = node.body; i < list.length; i += 1)
    {
    var elt = list[i];
...
base$2.MethodDefinition = base$2.PropertyDefinition = base$2.Property = function (node, st, c) {
...
const accessedMetaUrlGlobals = {
    ...
    cjs: ['document', 'require', 'URL', 'document.currentScript'],
    es: [],
    iife: ['document', 'URL', 'document.currentScript'],
    system: ['module'],
    umd: ['document', 'require', 'URL', 'document.currentScript']
};
...
const getUrlFromDocument = (chunkId, umd = false) => `${umd ? `typeof document === 'undefined' ? location.href : ` : ''}(document.currentScript && document.currentScript.tagName.toUpperCase() === 'SCRIPT' && document.currentScript.src || new URL('${escapeId(chunkId)}', document.baseURI).href)`;
...
class Module {
    ...
    tryParse() {
        try {
            // 如果 sdk 传了 meta.shouldEmitJs 以 sdk 传过来的标志为准， shouldEmitJs === false 时才能 useAcornLoose
            // 如果 sdk 没传 meta.shouldEmitJs 则必须显示设置 useAcornLoose===true且非 js 文件才能使用useAcornLoose
            const useAcornLoose = this.info?.meta?.shouldEmitJs
                ? !this.info.meta.shouldEmitJs
                : this.options.useAcornLoose && (this.id.endsWith('.ets') || this.id.endsWith('.ts'));
            return this.graph.contextParse(this.info.code, {}, useAcornLoose);
        }
        catch (error_) {
...
class ModuleLoader {
    constructor(graph, modulesById, options, pluginDriver, changedModules = new Set()) {
        this.graph = graph;
        this.modulesById = modulesById;
        this.options = options;
        this.pluginDriver = pluginDriver;
    ...
    async addModuleSource(id, importer, module, isPreload) {
        ...
        if (cachedModule &&
            ...
            this.changedModules.add(module.id);
        }
    }
...
class Graph {
    constructor(options, watcher) {
        ...
        this.acornLooseParser = require('./acorn/acorn-loose.js').LooseParser;
        this.acornParser = Parser.extend(...options.acornInjectPlugins);
        this.changedModules = new Set();
        this.moduleLoader = new ModuleLoader(this, this.modulesById, this.options, this.pluginDriver, this.changedModules);
    ...
    contextParse(code, options = {}, useAcornLoose = false) {
        ...
        options.onComment =
            onCommentOrig && typeof onCommentOrig == 'function'
                ...
                : comments;
        const parser = useAcornLoose ? this.acornLooseParser : this.acornParser;
...
const FUNC_STATEMENT = 1,
	FUNC_NULLABLE_ID = 4;
const importAssertions = plugin({ keyword: 'assert' });
	...
	return class extends Parser {
		...
		readToken(code) {
			...
			if (isWithOrAssertKeyword) {
				...
				for (; index < keyword.length; index++) {
					if (this._codeAt(this.pos + index) !== keyword.charCodeAt(index)) {
						return super.readToken(code);
					}
				}
			}
			...
			// ie `with{...` or `with {...`
			for (; ; index++) {
				if (this._codeAt(this.pos + index) === leftCurlyBrace) {
					// Found '{'
					break;
				} else if (this._codeAt(this.pos + index) === space) {
		...
		parseExport(node, exports) {
			...
			if (this.shouldParseExportStatement()) {
				...
				if (this.eatContextual('from')) {
					...
					for (var index = 0, list = node.specifiers; index < list.length; index += 1) {
						// check for keywords used as local names
						var spec = list[index];
		...
		parseImport(node) {
			...
			if (this.type === tt.string) {
				...
				const useLazy = this.isContextual('lazy');
				if (useLazy) {
					// 读到 lazy
					const lazyStart = this.start;
					const lazyEnd = this.end;
					this.next(); // 先跳到下一个token
					if (this.isContextual('from')) {
						// import lazy from 'xxx' 的场景，lazy 是default import的名字
						node.specifiers = [{
							type: 'ImportDefaultSpecifier',
							start: lazyStart,
							end: lazyEnd,
							local: { type: 'Identifier', start: lazyStart, end: lazyEnd, name: 'lazy' }
						}];
					} else {
						// import lazy xxx from 'yyy' 的场景，lazy 是一个关键字要忽略掉,继续解析 xxx
						node.specifiers = this.parseImportSpecifiers();
					}
				} else {
					node.specifiers = this.parseImportSpecifiers();
		...
		parseImportAttributes() {
			this._eat(tt.braceL);
			const attributes = this.parsewithEntries();
			this._eat(tt.braceR);
			return attributes;
		}
		...
		parsewithEntries() {
			...
			do {
				...
				if (attributeNames.has(node.key.name)) {
					this.raise(this.pos, 'Duplicated key in attributes');
				}
				attributeNames.add(node.key.name);
				...
				attributes.push(this.finishNode(node, 'ImportAttribute'));
...
async function normalizeInputOptions(config) {
    ...
    const options = {
        ...
        useAcornLoose: config.useAcornLoose || false
    };
...
async function rollupInternal(rawInputOptions, watcher) {
    ...
    const result = {
        ...
        changedModules: graph.getChangedModules(),
        async close() {
            if (result.closed)
                return;
            result.closed = true;
...
async function mergeInputOptions(config, overrides, defaultOnWarnHandler) {
    ...
    const inputOptions = {
        ...
        useAcornLoose: getOption("useAcornLoose")
    };
