...
include(HandleBiShengOptions)

option(LLVM_ENABLE_OPENMP_FFRT "Build support for OpenMP FFRT" OFF)
if(LLVM_ENABLE_OPENMP_FFRT)
  add_definitions( -DBSPRIV_COMMON_OPENMP_FFRT )
  if(${LLVM_ENABLE_OPENMP_FFRT} STREQUAL "mobile")
    add_definitions( -DBSPRIV_COMMON_OPENMP_FFRT_MOBILE )
    set(LLVM_ENABLE_OPENMP_FFRT "mobile")
  elseif(${LLVM_ENABLE_OPENMP_FFRT} STREQUAL "hpc")
    add_definitions( -DBSPRIV_COMMON_OPENMP_FFRT_HPC )
    set(LLVM_ENABLE_OPENMP_FFRT "hpc")
  endif()
else()
  set(LLVM_ENABLE_OPENMP_FFRT 0)
endif()
