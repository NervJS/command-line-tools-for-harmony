...
#if defined(BSPRIV_COMMON_INLINE)
  /// If this argument has the sparse_field attribute, return the field index of
  /// the struct.
  uint64_t getSparseFieldIndex() const;
#endif

  /// Return true if this argument has the intentin attribute.
  bool hasIntentInAttr() const;
#endif
