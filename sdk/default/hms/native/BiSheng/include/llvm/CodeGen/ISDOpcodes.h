...
enum NodeType {
...
#if defined(BSPRIV_AARCH64_COMPLEX)
  /// COMPLEX_FMA - Perform complex multiply and add.
  COMPLEX_FMA,
  COMPLEX_CONJ_FMA,
  COMPLEX_FSUB_FMA,
  COMPLEX_FSUB_CONJ_FMA,
#endif
  ...
  /// MASKED_PREFETCH - This corresponds to a prefetch intrinsic. The first operand
  /// is the chain.  The other operands are the masked vector, address to prefetch,
  /// read / write specifier, locality specifier and instruction / data cache
  /// specifier.
  MASKED_PREFETCH,
#endif
