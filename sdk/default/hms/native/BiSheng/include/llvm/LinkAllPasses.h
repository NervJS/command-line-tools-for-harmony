...
#include "llvm/Transforms/Scalar/AutoTuningDump.h"
#endif
#if defined(BSPUB_COMMON)
#include "llvm/Analysis/EscapeAnalysisAA.h"

#if defined(BSPRIV_COMMON_IR_LIBRARY_INJECTION)
#include "llvm/Transforms/IPO/IRLibraryInjection.h"
#endif
#endif
namespace {
...
#if defined(BSPUB_COMMON)
      (void) llvm::createEscapeAnalysisAAWrapperPass();
      (void) llvm::createEscapeAnalysisPass();
#if defined(BSPRIV_COMMON_IR_LIBRARY_INJECTION)
      (void) llvm::createIRLibraryInjectionPass();
#endif
#if defined(BSPRIV_COMMON_HASH_DATA_PREFETCH)
      (void) llvm::createHashDataPrefetchPass();
#endif
#if defined(BSPRIV_COMMON_LOOP_LOAD_WIDEN)
      (void) llvm::createLoopLoadWidenPass();
#endif
#endif
