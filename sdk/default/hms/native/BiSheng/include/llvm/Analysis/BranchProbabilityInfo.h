...
class Value;
#if defined(BSPUB_COMMON) && defined(BSPRIV_COMMON_BRANCH_PROBABILITY_INFO)
...
public:
  ...
  BranchProbabilityInfo(const Function &F, const LoopInfo &LI,
                        ...
                        const AssumptionCache *AC = nullptr,
                        const TargetTransformInfo *TTI = nullptr) {
    calculate(F, LI, TLI, DT, PDT, AC, TTI);
#else
                        PostDominatorTree *PDT = nullptr) {
...
public:
  ...
  void calculate(const Function &F, const LoopInfo &LI,
                 ...
                 const AssumptionCache *AC = nullptr,
                 const TargetTransformInfo *TTI = nullptr,
                 const ScalarEvolution *SE = nullptr);
#else
                 PostDominatorTree *PDT);
#endif
...
#else
  bool calcZeroHeuristics(const BasicBlock *BB, const TargetLibraryInfo *TLI,
                          const LoopInfo &LI, const ScalarEvolution *SE,
                          const TargetTransformInfo *TTI,
                          const AssumptionCache *AC);
  bool checkLargeLoopHeuristics(const BasicBlock *BB, const LoopInfo &LI,
                                const ScalarEvolution *SE,
                                const TargetTransformInfo *TTI,
                                const AssumptionCache *AC);
  bool calcEnhanceZeroHeuristics(const BasicBlock *BB);
  bool calcCallHeuristics(const BasicBlock *BB, DominatorTree *DT,
                          PostDominatorTree *PDT);
  bool calcEnhanceConsecutiveIfBlocks(const BasicBlock *BB);
#endif
};
