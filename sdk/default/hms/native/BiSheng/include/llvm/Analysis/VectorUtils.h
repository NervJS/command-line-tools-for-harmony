...
/// For stride that is a mul expr, we check if the value after multiply is
/// avaliable in the preheader and so we can return that value as the symbolic
/// stride.
Value *findSymbolicStrideForMulExpr(Value *Ptr, ScalarEvolution *SE, Loop *Lp);
#endif
