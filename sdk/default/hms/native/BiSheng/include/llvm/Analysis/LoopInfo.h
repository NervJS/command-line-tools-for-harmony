...
public:
  ...
  /// Return true if the loop contains only one basic block and no float
  /// operation without nnan attribute is included.
  bool isContainOneBBWithoutFloatNaNInsts() const;
#endif
