...
void initializeArrayAccessStrideAnalysisWrapperPass(PassRegistry &);
void initializeEscapeAnalysisPass(PassRegistry &);
void initializeEscapeAnalysisAAWrapperPassPass(PassRegistry &);
void initializeLoopReuseAnalysisPass(PassRegistry &);
#if defined(BSPRIV_COMMON_DDG)
void initializeDDGWrapperPassPass(PassRegistry &);
#endif
#if defined(BSPRIV_COMMON_HASH_DATA_PREFETCH)
void initializeHashDataPrefetchLegacyPassPass(PassRegistry &);
#endif
#if defined(BSPRIV_COMMON_IR_LIBRARY_INJECTION)
void initializeIRLibraryInjectionPass(PassRegistry &);
#endif
#if defined(BSPRIV_COMMON_LOOP_LOAD_WIDEN)
void initializeLoopLoadWidenLegacyPass(PassRegistry &);
#endif
#endif
} // end namespace llvm
