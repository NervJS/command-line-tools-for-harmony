...
public:
  ...
  /// Enable in house pipeline instead of using the default one.
  bool EnableCustomizedPipeline;
#endif
...
#if defined(BSPUB_COMMON)
  void populateModulePassManagerDefault(legacy::PassManagerBase &MPM);
  void populateModulePassManagerCustomized(legacy::PassManagerBase &MPM);
  void addFunctionSimplificationPassesCustomized(legacy::PassManagerBase &MPM);
#endif
