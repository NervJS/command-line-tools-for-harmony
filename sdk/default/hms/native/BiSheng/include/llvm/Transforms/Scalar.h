...
//
#if defined(BSPUB_COMMON) && defined(BSPRIV_COMMON_GVN)
FunctionPass *createGVNHoistPass(bool isDiamondLoadHoist = false);
#else
...
//===----------------------------------------------------------------------===//
//
// Hash Data Prefetch Pass - The pass aims to find repreated hash-like array
// accesses and insert prefetching calls to reduce wait time for load/store
// operations.
//
...
//===----------------------------------------------------------------------===//
//
// LoopLoadWiden - Perform loop-aware load widen.
//
FunctionPass *createLoopLoadWidenPass();
#endif
#endif
