...
public:
  ...
  /// Add extra values to the InsertedValues set. This is used by
  /// ExpanderCleaner in the LoopVectorizer's simplified memory check logic,
  /// which adds extra instructions that uses with the expander generated ones.
  void addExtraInsertedValues(Value *V) { InsertedValues.insert(V); }
#endif
