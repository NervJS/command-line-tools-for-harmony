...
public:
  ...
  DenseMap<Instruction *, Value *> cloneInstructions(BasicBlock::iterator BI,
                                                     BasicBlock::iterator BE, 
                                                     BasicBlock *NewBB,
                                                     const MapVector<BasicBlock *, int> &PredBBs);
  bool tryThreadEdge(BasicBlock *BB, const SmallVectorImpl<BasicBlock *> &PredBBs,
                     BasicBlock *SuccBB, Value *Cond, Value *ToVal);
  ...
  Constant *evaluateOnPredecessorEdge(BasicBlock *BB, BasicBlock *PredPredBB,
                                      Value *cond);
  void foldCurrentBasicBlock(Value *Cond, BasicBlock* BB, BasicBlock* DestBB,
                             Constant *OnlyVal);
  bool maybethreadThroughTwoBasicBlocks(BasicBlock *BB, Value *Cond);
  void threadThroughTwoBasicBlocks(const MapVector<BasicBlock *, int> &PredPredBBs,
