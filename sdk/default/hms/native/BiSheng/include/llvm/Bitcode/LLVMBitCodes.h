...
enum AttributeKindCodes {
  ...
  ATTR_KIND_INTENT_IN = 85,
#if defined(BSPRIV_COMMON_INLINE)
  ATTR_KIND_SPARSE_FIELD = 86,
#endif
#if defined(BSPRIV_COMMON_INLINE)
  ATTR_KIND_SROA_INFERRED_INLINING = 88,
#endif
#endif
  /// OHOS_LOCAL begin
  ATTR_KIND_STACK_PROTECT_RET_REQ = 89,
  ATTR_KIND_STACK_PROTECT_RET_STRONG = 90,
  ATTR_KIND_MIU = 91,
  ATTR_KIND_NO_MIU = 92,
  ATTR_KIND_MIUOPT = 93,
  /// OHOS_LOCAL end
  ATTR_KIND_BTB_RELAX = 94,
};
