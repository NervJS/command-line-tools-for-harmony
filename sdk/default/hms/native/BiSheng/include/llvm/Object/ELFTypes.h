...
template <class ELFT> struct Elf_IndirectCGProfile_Impl;
...
public:
  ...
  using IndirectCGProfile = Elf_IndirectCGProfile_Impl<ELFType<E, Is64>>;
...
#define LLVM_ELF_IMPORT_TYPES_ELFT(ELFT)                                       \
  ...
  using Elf_IndirectCGProfile = typename ELFT::IndirectCGProfile;              \
