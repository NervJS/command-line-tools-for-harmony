...
/// OpenMP attributes for 'deadline_qos' clause.
enum OpenMPDeadlineQOSClauseKind {
#define OPENMP_DEADLINE_QOS_KIND(Name) OMPC_DEADLINE_QOS_##Name,
#include "clang/Basic/OpenMPKinds.def"
  OMPC_DEADLINE_QOS_unknown,
};
#endif
