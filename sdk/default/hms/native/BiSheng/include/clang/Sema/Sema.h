...
public:
  ...
  /// Called on well-formed 'deadline' clause.
  OMPClause *ActOnOpenMPDeadlineClause(Expr *DeadlineNum,
                                       SourceLocation StartLoc,
                                       SourceLocation LParenLoc,
                                       SourceLocation EndLoc);
#endif
  ...
  OMPClause *ActOnOpenMPOrderClause(OpenMPOrderClauseKind Kind,
                                    ...
                                    SourceLocation EndLoc);
#ifdef BSPRIV_COMMON_OPENMP_FFRT
  /// Called on well-formed 'deadline_qos' clause.
  OMPClause *ActOnOpenMPDeadlineQOSClause(OpenMPDeadlineQOSClauseKind Kind,
                                          SourceLocation KindLoc,
                                          SourceLocation StartLoc,
                                          SourceLocation LParenLoc,
                                          SourceLocation EndLoc);
