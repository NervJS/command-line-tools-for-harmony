...
public:
  /// OHOS_LOCAL begin
  /// Return the uniqued reference to a miu pointer type
  ///  The resulting type has a union of the qualifiers from T and the miu
  ///  qualifier
  QualType getMiuPtrQualType(QualType T) const;
  QualType getNoMiuPtrQualType(QualType T) const;
  /// OHOS_LOCAL end
